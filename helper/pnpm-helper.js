    ...
    if (workspace.includes('/*')) {
        ...
        subfolder.forEach(subfolder => {
            ...
            if (fileExists(`${commander_plus_1.default.folder}/${myWorkspace}/${subfolder}/package.json`)) {
                ...
                if (commander_plus_1.default.intRepoPrefix != undefined) {
                    ...
                    if (packageJson.dependencies) {
                        for (const [key, value] of Object.entries(packageJson.dependencies)) {
                            if (key.includes(commander_plus_1.default.intRepoPrefix)) {
                ...
                try {
                    console.log(chalk_1.default.green(`\n## Running npm install --package-lock-only --workspaces=false --force in ${commander_plus_1.default.folder}/${myWorkspace}/${subfolder}...`));
                    (0, child_process_1.execSync)(`cd ${commander_plus_1.default.folder}/${myWorkspace}/${subfolder} && npm i --package-lock-only --workspaces=false --force`, { stdio: 'inherit' });
                }
                catch (err) {
                    console.error(chalk_1.default.red(`Error running npm install: ${err.message}`));
                }
            }
        });
    }

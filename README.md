...
For guidance on installing the Veracode Workflow Application and additional information about the integration, please view the Veracode documentation. URL - https://docs.veracode.com/r/GitHub_Workflow_Integration_for_Repo_Scanning
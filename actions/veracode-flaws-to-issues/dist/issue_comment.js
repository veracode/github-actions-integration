...
function addVeracodeIssueComment(_x, _x2) {
  return _addVeracodeIssueComment.apply(this, arguments);
}
function _addVeracodeIssueComment() {
  _addVeracodeIssueComment = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(options, issueComment) {
    var ApiError, githubOwner, githubRepo, githubToken, authToken;
        ...
        case 0:
          ...
          return request('POST /repos/{owner}/{repo}/issues/{issue_number}/comments', {
            ...
            if (error.status == 403 && error.message.indexOf('abuse detection') > 0) {
              ...
              throw new Error("Error ".concat(error.status, " creating Issue for \"").concat(issueComment.issue_number, "\": ").concat(error.message));
            }
          });
        case 1:
          return _context.a(2);
...
module.exports = {
  addVeracodeIssueComment: addVeracodeIssueComment
};